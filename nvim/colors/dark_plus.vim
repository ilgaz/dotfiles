...
"       highlight SpecialComment ctermfg=2 guifg=#608b4e cterm=italic
"       gui=italic
"       highlight PlainText ctermfg=7 guifg=#d4d4d4 ctermbg=NONE guibg=NONE
"       cterm=NONE gui=NONE
"       highlight Control ctermfg=13 guifg=#c586c0 ctermbg=NONE guibg=NONE
"       cterm=NONE gui=NONE
...
"       highlight User1 ctermfg=0 guifg=#1e1e1e ctermbg=2 guibg=#608b4e
"       cterm=NONE gui=NONE
"       highlight User2 ctermfg=7 guifg=#d4d4d4 ctermbg=0 guibg=#505050
"       cterm=NONE gui=NONE
"       highlight User3 ctermfg=2 guifg=#608b4e ctermbg=0 guibg=#303030
"       cterm=NONE gui=NONE
"       highlight Normal ctermfg=7 guifg=#d4d4d4 ctermbg=0 guibg=#1e1e1e
"       cterm=NONE gui=NONE
...
"       highlight EndOfBuffer ctermfg=0 guifg=#505050 ctermbg=0 guibg=#1e1e1e
"       cterm=NONE gui=NONE
"       highlight ErrorMsg ctermfg=1 guifg=#d16969 ctermbg=NONE guibg=NONE
"       cterm=NONE gui=NONE
"       highlight VertSplit ctermfg=0 guifg=#1e1e1e ctermbg=0 guibg=#303030
"       cterm=NONE gui=NONE
"       highlight Folded ctermfg=0 guifg=#505050 ctermbg=NONE guibg=NONE
"       cterm=NONE gui=NONE
"       highlight FoldColumn ctermfg=0 guifg=#1e1e1e ctermbg=0 guibg=#303030
"       cterm=NONE gui=NONE
"       highlight SignColumn ctermbg=0 guibg=#1e1e1e cterm=NONE gui=NONE
"       highlight IncSearch ctermfg=NONE guifg=NONE ctermbg=4 guibg=#264f78
"       cterm=NONE gui=NONE
"       highlight LineNr ctermfg=0 guifg=#505050 ctermbg=0 guibg=#1e1e1e
"       cterm=NONE gui=NONE
"       highlight CursorLineNr ctermfg=2 guifg=#608b4e ctermbg=0 guibg=#1e1e1e
"       cterm=NONE gui=NONE
...
"       highlight NonText ctermfg=7 guifg=#808080 ctermbg=NONE guibg=NONE
"       cterm=NONE gui=NONE
"       highlight Pmenu ctermfg=7 guifg=#d4d4d4 ctermbg=0 guibg=#303030
"       cterm=NONE gui=NONE
"       highlight PmenuSel ctermfg=7 guifg=#d4d4d4 ctermbg=4 guibg=#264f78
"       cterm=NONE gui=NONE
...
"       highlight Question ctermfg=6 guifg=#4ec9b0 ctermbg=NONE guibg=NONE
"       cterm=NONE gui=NONE
"       highlight Search ctermfg=0 guifg=#1e1e1e ctermbg=7 guibg=#d4d4d4
"       cterm=NONE gui=NONE
"       highlight Substitute ctermfg=NONE guifg=NONE ctermbg=7 guibg=#d4d4d4
"       cterm=NONE gui=NONE
"       highlight SpellBad ctermfg=1 guifg=#d16969 ctermbg=NONE guibg=NONE
"       cterm=NONE gui=NONE
"       highlight SpellCap ctermfg=1 guifg=#d16969 ctermbg=NONE guibg=NONE
"       cterm=NONE gui=NONE
"       highlight SpellRare ctermfg=1 guifg=#d16969 ctermbg=NONE guibg=NONE
"       cterm=NONE gui=NONE
"       highlight SpellLocal ctermfg=1 guifg=#d16969 ctermbg=NONE guibg=NONE
"       cterm=NONE gui=NONE
...
"       cterm=italic gui=italic
"       highlight TabLineSel ctermfg=7 guifg=#d4d4d4 ctermbg=0 guibg=#1e1e1e
"       cterm=NONE gui=NONE
...
"       highlight VisualNOS ctermfg=NONE guifg=NONE ctermbg=4 guibg=#264f78
"       cterm=NONE gui=NONE
"       highlight WarningMsg ctermfg=3 guifg=#ce9178 cterm=NONE gui=NONE
"       highlight WildMenu ctermfg=7 guifg=#d4d4d4 ctermbg=4 guibg=#264f78
"       cterm=NONE gui=NONE
...
"       highlight Conceal ctermfg=7 guifg=#d4d4d4 ctermbg=0 guibg=#1e1e1e
"       cterm=NONE gui=NONE
"       highlight Error ctermfg=1 guifg=#d16969 ctermbg=NONE guibg=NONE
"       cterm=NONE gui=NONE
"       highlight Todo ctermfg=7 guifg=#d4d4d4 ctermbg=2 guibg=#608b4e
"       cterm=bold,italic gui=bold,italic
"       highlight Underlined cterm=underline gui=underline
"       highlight qfFileName ctermfg=4 guifg=#569cd6 ctermbg=NONE guibg=NONE
"       cterm=NONE gui=NONE
"       highlight qfLineNr ctermfg=9 guifg=#b5cea8 ctermbg=NONE guibg=NONE
"       cterm=NONE gui=NONE
"       highlight helpHyperTextEntry ctermfg=6 guifg=#9cdcfe cterm=NONE
"       gui=NONE
"       highlight helpHyperTextJump ctermfg=6 guifg=#9cdcfe cterm=NONE
"       gui=NONE
...
"       highlight gitcommitUntracked ctermfg=3 guifg=#d7ba7d cterm=NONE
"       gui=NONE
"       highlight gitcommitDiscarded ctermfg=13 guifg=#c586c0 cterm=NONE
"       gui=NONE
...
"       highlight goStandardLib ctermfg=7 guifg=#d4d4d4 cterm=italic
"       gui=italic
"       highlight goPackageName ctermfg=7 guifg=#d4d4d4 cterm=italic
"       gui=italic
...
"       highlight goUnsignedInts ctermfg=6 guifg=#4ec9b0 cterm=italic
"       gui=italic
...
"       highlight htmlSpecialTagName ctermfg=4 guifg=#569cd6 cterm=NONE
"       gui=NONE
...
"       highlight markdownHeadingDelimiter ctermfg=13 guifg=#c586c0 cterm=NONE
"       gui=NONE
"       highlight markdownItalic ctermfg=6 guifg=#9cdcfe cterm=italic
"       gui=italic
"       highlight markdownItalicDelimiter ctermfg=0 guifg=#505050 cterm=NONE
"       gui=NONE
"       highlight markdownBold ctermfg=4 guifg=#569cd6 cterm=bold gui=bold
"       highlight markdownBoldDelimiter ctermfg=0 guifg=#505050 cterm=NONE
"       gui=NONE
"       highlight markdownListMarker ctermfg=4 guifg=#007acc cterm=NONE
"       gui=NONE
...
"       highlight markdownBlockquote ctermfg=2 guifg=#608b4e cterm=NONE
"       gui=NONE
...
"       highlight pythonBuiltinFunc ctermfg=4 guifg=#569cd6 cterm=NONE
"       gui=NONE
"       highlight pythonClassVar ctermfg=4 guifg=#569cd6 cterm=italic
"       gui=italic
...
"       highlight pythonIncludeLine ctermfg=6 guifg=#4ec9b0 cterm=NONE
"       gui=NONE
"       highlight pythonImportedModule ctermfg=6 guifg=#9cdcfe cterm=NONE
"       gui=NONE
"       highlight pythonImportedObject ctermfg=6 guifg=#4ec9b0 cterm=NONE
"       gui=NONE
"       highlight pythonImportedFuncDef ctermfg=3 guifg=#dcdcaa cterm=NONE
"       gui=NONE
...
"       highlight zshPrecommand ctermfg=3 guifg=#dcdcaa cterm=italic
"       gui=italic
...
"       highlight CSVColumnHeaderEven ctermfg=0 guifg=#1e1e1e ctermbg=4
"       guibg=#569cd6 cterm=NONE gui=NONE
"       highlight CSVColumnHeaderOdd ctermfg=0 guifg=#1e1e1e ctermbg=2
"       guibg=#608b4e cterm=NONE gui=NONE
...
"       highlight vimLineComment ctermfg=0 guifg=#505050 cterm=italic
"       gui=italic
...
"       highlight vimSynNotPatRange ctermfg=4 guifg=#569cd6 cterm=NONE
"       gui=NONE
"       highlight vimSynMatchRegion ctermfg=1 guifg=#d16969 cterm=NONE
"       gui=NONE
...
"       highlight yamlDocumentStart ctermfg=13 guifg=#c586c0 cterm=NONE
"       gui=NONE
"       highlight yamlDocumentEnd ctermfg=13 guifg=#c586c0 cterm=NONE gui=NONE
"       highlight yamlKeyValueDelimiter ctermfg=13 guifg=#c586c0 cterm=NONE
"       gui=NONE
...
"       highlight snipTabStopDefault ctermfg=6 guifg=#9cdcfe cterm=NONE
"       gui=NONE
...
"       highlight snipPythonCommand ctermfg=6 guifg=#4ec9b0 cterm=NONE
"       gui=NONE
"       highlight snipPythonCommandP ctermfg=6 guifg=#4ec9b0 cterm=NONE
"       gui=NONE
"       highlight snipSnippetOptions cterm=NONE gui=NONE
"       highlight snipGlobal ctermfg=13 guifg=#c586c0 cterm=NONE gui=NONE
"       highlight snipGlobalPHeader ctermfg=6 guifg=#4ec9b0 cterm=NONE
"       gui=NONE
"       highlight snipGlobalHeaderKeyword ctermfg=13 guifg=#c586c0 cterm=NONE
"       gui=NONE
"       highlight snipSnippetOptionFlag ctermfg=13 guifg=#c586c0 cterm=NONE
"       gui=NONE
...
"       highlight tmuxFmtConditional ctermfg=13 guifg=#c586c0 cterm=NONE
"       gui=NONE
...
"       highlight tmuxWindowPaneCmds ctermfg=3 guifg=#dcdcaa cterm=NONE
"       gui=NONE
...
"       highlight tmuxAttrSeparator ctermfg=7 guifg=#808080 cterm=NONE
"       gui=NONE
...
"       highlight tmuxFmtInpolDelimiter ctermfg=4 guifg=#569cd6 cterm=NONE
"       gui=NONE
"       highlight tmuxAttrInpolDelimiter ctermfg=4 guifg=#569cd6 cterm=NONE
"       gui=NONE
"       highlight tmuxShellInpolDelimiter ctermfg=4 guifg=#569cd6 cterm=NONE
"       gui=NONE
...
"       highlight ALEInfoSign ctermfg=9 guifg=#b5cea8 ctermbg=0 guibg=#1e1e1e
"       cterm=NONE gui=NONE
"       highlight ALEErrorSign ctermfg=1 guifg=#d16969 ctermbg=0 guibg=#1e1e1e
"       cterm=NONE gui=NONE
"       highlight ALEWarningSign ctermfg=3 guifg=#d7ba7d ctermbg=0
"       guibg=#1e1e1e cterm=NONE gui=NONE
"       highlight ALEStyleErrorSign ctermfg=3 guifg=#dcdcaa ctermbg=0
"       guibg=#1e1e1e cterm=NONE gui=NONE
"       highlight ALEStyleWarningSign ctermfg=3 guifg=#dcdcaa ctermbg=0
"       guibg=#1e1e1e cterm=NONE gui=NONE
...
"       highlight BookmarkSign ctermfg=6 guifg=#4ec9b0 ctermbg=0 guibg=#303030
"       cterm=NONE gui=NONE
"       highlight BookmarkAnnotationSign ctermfg=6 guifg=#4ec9b0 ctermbg=0
"       guibg=#303030 cterm=NONE gui=NONE
"       highlight BookmarkLine cterm=NONE gui=NONE
"       highlight BookmarkAnnotationLine cterm=NONE gui=NONE
"       highlight BufTabLineCurrent ctermfg=0 guifg=#1e1e1e ctermbg=2
"       guibg=#608b4e cterm=NONE gui=NONE
"       highlight BufTabLineActive ctermfg=2 guifg=#608b4e ctermbg=0
"       guibg=#303030 cterm=NONE gui=NONE
"       highlight BufTabLineHidden ctermfg=7 guifg=#d4d4d4 ctermbg=0
"       guibg=#303030 cterm=NONE gui=NONE
"       highlight BufTabLineFill ctermbg=0 guibg=#303030 cterm=NONE gui=NONE
"       highlight deniteMatchedChar ctermfg=6 guifg=#4ec9b0 cterm=underline
"       gui=underline
"       highlight denitePrompt ctermfg=6 guifg=#4ec9b0 cterm=NONE gui=NONE
"       highlight deniteConcealedMark ctermfg=4 guifg=#264f78 cterm=NONE
"       gui=NONE
...
"       highlight deniteSource_Projectile_Name ctermfg=6 guifg=#4ec9b0
"       cterm=NONE gui=NONE
"       highlight GitGutterAdd ctermfg=2 guifg=#608b4e ctermbg=0 guibg=#1e1e1e
"       cterm=NONE gui=NONE
"       highlight GitGutterChange ctermfg=3 guifg=#d7ba7d ctermbg=0
"       guibg=#1e1e1e cterm=NONE gui=NONE
"       highlight GitGutterDelete ctermfg=1 guifg=#d16969 ctermbg=0
"       guibg=#1e1e1e cterm=NONE gui=NONE
"       highlight GitGutterChangeDelete ctermfg=3 guifg=#d7ba7d ctermbg=0
"       guibg=#1e1e1e cterm=NONE gui=NONE
...
"       highlight uniteStatusNormal ctermfg=2 guifg=#608b4e cterm=NONE
"       gui=NONE
"       highlight uniteStatusInsert ctermfg=4 guifg=#569cd6 cterm=NONE
"       gui=NONE
...
"       highlight vimfilerColumn__devicons ctermfg=7 guifg=#808080 cterm=NONE
"       gui=NONE
"       highlight vimfilerDirectory ctermfg=4 guifg=#569cd6 cterm=NONE
"       gui=NONE
...
"       highlight vimfilerNormalFile ctermfg=7 guifg=#d4d4d4 cterm=NONE
"       gui=NONE
"       highlight vimfilerOpenedFile ctermfg=6 guifg=#9cdcfe cterm=NONE
"       gui=NONE
"       highlight vimfilerClosedFile ctermfg=4 guifg=#569cd6 cterm=NONE
"       gui=NONE
"       highlight vimfilerMarkedFile ctermfg=2 guifg=#608b4e cterm=NONE
"       gui=NONE
